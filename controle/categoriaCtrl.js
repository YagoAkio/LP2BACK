...
export default class CategoriaCtrl {
    ...
    consultar(requisicao, resposta) {
        ...
        // Captura o termo da URL ou inicializa como string vazia
        const termo = requisicao.params.termo || requisicao.query.termo || "";
    
        // Adicionando log para verificar o valor de termo e o método
        console.log("Método:", requisicao.method);
        console.log("Parâmetro 'termo' recebido:", termo);
    
        if (requisicao.method === "GET") {
            const categoria = new Categoria();
            categoria.consultar(termo)
                ...
                .catch((erro) => {
                    console.error("Erro ao consultar categorias:", erro.message);
                    resposta.json({
                        status: false,
